...
Shader "Triplebrick/Cutout_Single_RGB_HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BaseColor_Alpha("BaseColor_Alpha", 2D) = "white" {}
		_Mask("Mask", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_BaseColor_Alpha = packedInput.ase_texcoord5.xy * _BaseColor_Alpha_ST.xy + _BaseColor_Alpha_ST.zw;
				float4 tex2DNode24 = tex2D( _BaseColor_Alpha, uv_BaseColor_Alpha );
				float2 uv_Mask = packedInput.ase_texcoord5.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 tex2DNode2 = tex2D( _Mask, uv_Mask );
				float4 lerpResult13 = lerp( tex2DNode24 , ( tex2DNode24 * tex2DNode2.g ) , _DirtAmount);
				
				float lerpResult18 = lerp( 1.0 , tex2DNode2.r , _ScratchesAmount);
				float lerpResult10 = lerp( tex2DNode2.a , tex2DNode2.b , _WearAmount);
				
				surfaceDescription.Albedo = ( lerpResult13 * _TintColor ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BaseColor_Alpha = packedInput.ase_texcoord.xy * _BaseColor_Alpha_ST.xy + _BaseColor_Alpha_ST.zw;
				float4 tex2DNode24 = tex2D( _BaseColor_Alpha, uv_BaseColor_Alpha );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BaseColor_Alpha = packedInput.ase_texcoord7.xy * _BaseColor_Alpha_ST.xy + _BaseColor_Alpha_ST.zw;
				float4 tex2DNode24 = tex2D( _BaseColor_Alpha, uv_BaseColor_Alpha );
...
/*ASEBEGIN
Version=18800
381.3456;78.30415;700.0829;484.2166;529.6481;280.5054;1.592286;True;False
Node;AmplifyShaderEditor.SamplerNode;2;-900.6737,-35.1236;Inherit;True;Property;_Mask;Mask;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-1301.261,-725.3196;Inherit;True;Property;_BaseColor_Alpha;BaseColor_Alpha;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;-1175.857,-198.9548;Float;False;Property;_DirtAmount;Dirt Amount;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-747.3376,-390.5056;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-628.5518,452.6429;Float;False;Property;_ScratchesAmount;Scratches Amount;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-568.298,194.0022;Float;False;Property;_WearAmount;Wear Amount;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;4;-364.5142,-827.569;Float;False;Property;_TintColor;Tint Color;2;0;Create;True;0;0;0;False;0;False;0.5882353,0.5882353,0.5882353,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;49;279.1568,316.2715;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
WireConnection;63;0;12;0
WireConnection;63;4;21;0
WireConnection;63;9;17;0
ASEEND*/
//CHKSM=A1955C004EB7FD22169F25BE5E204BB5ED8DC047