...
Shader "Triplebrick/Base_Normal_Replace_HDRP"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_BaseNormal("Base Normal", 2D) = "white" {}
		...
		[ASEEnd]_DetailDirtStrength("Detail Dirt Strength", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv4_DirtRoughness = packedInput.ase_texcoord5.xy * _DirtRoughness_ST.xy + _DirtRoughness_ST.zw;
				...
				float2 uv_DetailMask = packedInput.ase_texcoord5.zw * _DetailMask_ST.xy + _DetailMask_ST.zw;
				...
				float2 uv_DetailNormal = packedInput.ase_texcoord5.zw * _DetailNormal_ST.xy + _DetailNormal_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal ), 1.0f );
				float2 uv4_BaseNormal = packedInput.ase_texcoord5.xy * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				float3 lerpResult11 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _BaseNormal, uv4_BaseNormal ), 1.0f ) , _BaseNormalStrength);
				float2 texCoord104 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float clampResult111 = clamp( ( texCoord104.x + -0.92 ) , 0.0 , 1.0 );
				float clampResult112 = clamp( ( texCoord104.y + -0.92 ) , 0.0 , 1.0 );
				...
				surfaceDescription.Albedo = ( lerpResult76 * lerpResult32 ).rgb;
				surfaceDescription.Normal = lerpResult115;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = clampResult144;
				...
				surfaceDescription.Smoothness = lerpResult121.r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv4_DirtRoughness = packedInput.ase_texcoord.xy * _DirtRoughness_ST.xy + _DirtRoughness_ST.zw;
				float4 tex2DNode143 = tex2D( _DirtRoughness, uv4_DirtRoughness );
				float clampResult77 = clamp( pow( tex2DNode143.g , _BaseDirtStrength ) , 0.0 , 1.0 );
				float4 lerpResult76 = lerp( _BaseDirtColor , float4( 1,1,1,0 ) , clampResult77);
				float4 lerpResult71 = lerp( _BaseColor , _BaseColorOverlay , tex2DNode143.r);
				float2 uv_DetailMask = packedInput.ase_texcoord.zw * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode36 = tex2D( _DetailMask, uv_DetailMask );
				float4 lerpResult134 = lerp( lerpResult71 , _DetailColor , ceil( ( ( 1.0 - tex2DNode36.b ) + -0.95 ) ));
				float temp_output_120_0 = ceil( ( tex2DNode36.b + -0.8 ) );
				float4 lerpResult123 = lerp( lerpResult134 , float4( float3(1,0.95,0.9) , 0.0 ) , temp_output_120_0);
				...
				float2 uv_DetailNormal = packedInput.ase_texcoord.zw * _DetailNormal_ST.xy + _DetailNormal_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal ), 1.0f );
				float2 uv4_BaseNormal = packedInput.ase_texcoord.xy * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				float3 lerpResult11 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _BaseNormal, uv4_BaseNormal ), 1.0f ) , _BaseNormalStrength);
				float2 texCoord104 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float clampResult111 = clamp( ( texCoord104.x + -0.92 ) , 0.0 , 1.0 );
				float clampResult112 = clamp( ( texCoord104.y + -0.92 ) , 0.0 , 1.0 );
				float3 lerpResult115 = lerp( tex2DNode3 , lerpResult11 , ( ceil( clampResult111 ) * ceil( clampResult112 ) ));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_DetailNormal = packedInput.ase_texcoord3.xy * _DetailNormal_ST.xy + _DetailNormal_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal ), 1.0f );
				float2 uv4_BaseNormal = packedInput.ase_texcoord3.zw * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				float3 lerpResult11 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _BaseNormal, uv4_BaseNormal ), 1.0f ) , _BaseNormalStrength);
				float2 texCoord104 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float clampResult111 = clamp( ( texCoord104.x + -0.92 ) , 0.0 , 1.0 );
				float clampResult112 = clamp( ( texCoord104.y + -0.92 ) , 0.0 , 1.0 );
				float3 lerpResult115 = lerp( tex2DNode3 , lerpResult11 , ( ceil( clampResult111 ) * ceil( clampResult112 ) ));
				...
				float4 tex2DNode36 = tex2D( _DetailMask, uv_DetailMask );
				float clampResult62 = clamp( ( ( tex2DNode36.r + -0.55 ) * 2.0 ) , 0.0 , 1.0 );
				float2 uv4_DirtRoughness = packedInput.ase_texcoord3.zw * _DirtRoughness_ST.xy + _DirtRoughness_ST.zw;
				float4 tex2DNode143 = tex2D( _DirtRoughness, uv4_DirtRoughness );
				float clampResult77 = clamp( pow( tex2DNode143.g , _BaseDirtStrength ) , 0.0 , 1.0 );
				float4 lerpResult76 = lerp( _BaseDirtColor , float4( 1,1,1,0 ) , clampResult77);
				float4 temp_cast_0 = (_DetailEdgeSmoothness).xxxx;
				float lerpResult94 = lerp( 0.0 , clampResult62 , _DetailEdgeWear);
				float temp_output_120_0 = ceil( ( tex2DNode36.b + -0.8 ) );
				float clampResult97 = clamp( ( lerpResult94 + temp_output_120_0 ) , 0.0 , 1.0 );
				float4 lerpResult121 = lerp( ( ( max( clampResult62 , tex2DNode143.a ) * lerpResult76 ) * _BaseSmoothness ) , temp_cast_0 , clampResult97);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv4_DirtRoughness = packedInput.ase_texcoord7.xy * _DirtRoughness_ST.xy + _DirtRoughness_ST.zw;
				float4 tex2DNode143 = tex2D( _DirtRoughness, uv4_DirtRoughness );
				float clampResult77 = clamp( pow( tex2DNode143.g , _BaseDirtStrength ) , 0.0 , 1.0 );
				float4 lerpResult76 = lerp( _BaseDirtColor , float4( 1,1,1,0 ) , clampResult77);
				float4 lerpResult71 = lerp( _BaseColor , _BaseColorOverlay , tex2DNode143.r);
				float2 uv_DetailMask = packedInput.ase_texcoord7.zw * _DetailMask_ST.xy + _DetailMask_ST.zw;
				float4 tex2DNode36 = tex2D( _DetailMask, uv_DetailMask );
				float4 lerpResult134 = lerp( lerpResult71 , _DetailColor , ceil( ( ( 1.0 - tex2DNode36.b ) + -0.95 ) ));
				float temp_output_120_0 = ceil( ( tex2DNode36.b + -0.8 ) );
				float4 lerpResult123 = lerp( lerpResult134 , float4( float3(1,0.95,0.9) , 0.0 ) , temp_output_120_0);
				...
				float2 uv_DetailNormal = packedInput.ase_texcoord7.zw * _DetailNormal_ST.xy + _DetailNormal_ST.zw;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _DetailNormal, uv_DetailNormal ), 1.0f );
				float2 uv4_BaseNormal = packedInput.ase_texcoord7.xy * _BaseNormal_ST.xy + _BaseNormal_ST.zw;
				float3 lerpResult11 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _BaseNormal, uv4_BaseNormal ), 1.0f ) , _BaseNormalStrength);
				float2 texCoord104 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float clampResult111 = clamp( ( texCoord104.x + -0.92 ) , 0.0 , 1.0 );
				float clampResult112 = clamp( ( texCoord104.y + -0.92 ) , 0.0 , 1.0 );
				float3 lerpResult115 = lerp( tex2DNode3 , lerpResult11 , ( ceil( clampResult111 ) * ceil( clampResult112 ) ));
...
/*ASEBEGIN
Version=18800
381.3456;78.30415;700.0829;484.2166;870.3189;62.29878;1.3;True;False
...
Node;AmplifyShaderEditor.SamplerNode;36;-3346.899,-727.3181;Inherit;True;Property;_DetailMask;Detail Mask;3;0;Create;True;0;0;0;False;0;False;-1;None;4a3848591ce935e4dad9a07fc6696f83;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;72;-3394.463,442.1131;Float;False;Property;_BaseColorOverlay;Base Color Overlay;5;0;Create;True;0;0;0;False;0;False;0.6544118,0.6544118,0.6544118,0;0.9294118,0.9411765,0.9490196,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-3384.122,232.3007;Float;False;Property;_BaseColor;Base Color;4;0;Create;True;0;0;0;False;0;False;0.6544118,0.6544118,0.6544118,0;0.9490196,0.945098,0.9294118,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;143;-3339.083,-1003.106;Inherit;True;Property;_DirtRoughness;Dirt Roughness;1;0;Create;True;0;0;0;False;0;False;-1;None;9ee49387df9326442af2587f7e7327c3;True;3;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;135;-2727.841,-120.0552;Float;False;Property;_DetailColor;Detail Color;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3215685,0.3215685,0.3215685,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;124;-2305.558,-92.16446;Float;False;Constant;_MetalTrimColor;MetalTrimColor;15;0;Create;True;0;0;0;False;0;False;1,0.95,0.9;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1825.482,-1086.847;Float;False;Property;_BaseDirtStrength;Base Dirt Strength;10;0;Create;True;0;0;0;False;0;False;0;0.01;0.001;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-1709.371,39.12919;Float;False;Property;_DetailDirtStrength;Detail Dirt Strength;14;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1382.548,84.26886;Float;False;Property;_DetailEdgeWear;Detail Edge Wear;12;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;75;-1364.064,-1160.842;Float;False;Property;_BaseDirtColor;Base Dirt Color;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2039215,0.1647058,0.07450978,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;10;-2528.757,1410.333;Float;False;Constant;_Vector0;Vector 0;3;0;Create;True;0;0;0;False;0;False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-1418.552,817.4737;Float;False;Property;_BaseMetallic;Base Metallic;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CeilOpNode;113;-1580.688,1754.212;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-2556.354,1703.328;Float;False;Property;_BaseNormalStrength;Base Normal Strength;8;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1045.729,75.21457;Float;False;Property;_BaseSmoothness;Base Smoothness;9;0;Create;True;0;0;0;False;0;False;0.5;0.75;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2;-3041.785,1516.055;Inherit;True;Property;_BaseNormal;Base Normal;0;0;Create;True;0;0;0;False;0;False;-1;None;7d09e7c7fffa5a94eadbfb28633eaa1e;True;3;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;3;-3014.076,1273.918;Inherit;True;Property;_DetailNormal;Detail Normal;2;0;Create;True;0;0;0;False;0;False;-1;None;1c1221435ae8dd740802e4127090b7fa;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;122;-667.9778,-185.7681;Float;False;Property;_DetailEdgeSmoothness;Detail Edge Smoothness;13;0;Create;True;0;0;0;False;0;False;0;0.74;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;137;-361.1563,453.2509;Float;False;Property;_DetailOcclusionStrength;Detail Occlusion Strength;16;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;208.0109,-674.2496;Float;False;Property;_DetailRoughnessContrast;Detail Roughness Contrast;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
WireConnection;145;7;121;0
ASEEND*/
//CHKSM=A089D0324142FD0EF281BA505EF8F93CF1021CB3