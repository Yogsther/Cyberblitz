...
Shader "Triplebrick/Cutout_Single_Channel_HDRP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Mask("Mask", 2D) = "white" {}
		...
		[ASEEnd]_ScratchesAmount("Scratches Amount", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 fetchOpaqueVal22 = ASEHDSampleSceneColor(ase_grabScreenPosNorm, 0, GetInverseCurrentExposureMultiplier());
				float2 uv_Mask = packedInput.ase_texcoord6.xy * _Mask_ST.xy + _Mask_ST.zw;
				...
				float4 blendOpSrc23 = fetchOpaqueVal22;
				float4 blendOpDest23 = ( lerpResult13 * _TintColor );
				
				float lerpResult18 = lerp( 1.0 , tex2DNode2.r , _ScratchesAmount);
				float lerpResult10 = lerp( tex2DNode2.a , tex2DNode2.b , _WearAmount);
				
				surfaceDescription.Albedo = ( saturate( (( blendOpDest23 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest23 ) * ( 1.0 - blendOpSrc23 ) ) : ( 2.0 * blendOpDest23 * blendOpSrc23 ) ) )).rgb;
				...
				surfaceDescription.Alpha = ( lerpResult18 * lerpResult10 );
		...
		Pass
		{
						...
						)
			{
				...
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float4 fetchOpaqueVal22 = ASEHDSampleSceneColor(ase_grabScreenPosNorm, 0, GetInverseCurrentExposureMultiplier());
				float2 uv_Mask = packedInput.ase_texcoord8.xy * _Mask_ST.xy + _Mask_ST.zw;
				float4 tex2DNode2 = tex2D( _Mask, uv_Mask );
				float4 temp_cast_0 = (tex2DNode2.g).xxxx;
				float4 lerpResult13 = lerp( float4(1,1,1,0) , temp_cast_0 , _DirtAmount);
				float4 blendOpSrc23 = fetchOpaqueVal22;
...
WireConnection;49;4;21;0
WireConnection;49;9;17;0
ASEEND*/
//CHKSM=90FBBF4FED1527C05D2E965C5E8D2E83E778CC03