...
Shader "Triplebrick/DoubleLayer_HDRP"
{
	Properties
	{
		...
		[ASEEnd]_CoatNormalStrength("Coat Normal Strength", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_CoatNormal = packedInput.ase_texcoord5.xy * _CoatNormal_ST.xy + _CoatNormal_ST.zw;
				float3 unpack332 = UnpackNormalScale( tex2D( _CoatNormal, uv_CoatNormal ), _CoatNormalStrength );
				unpack332.z = lerp( 1, unpack332.z, saturate(_CoatNormalStrength) );
				
				surfaceDescription.Albedo = ( tex2D( _Basecolor, uv_Basecolor ) * _BasecolorTint ).rgb;
				surfaceDescription.Normal = unpack332;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0.0;
				...
				surfaceDescription.Smoothness = 0.9;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_CoatNormal = packedInput.ase_texcoord.xy * _CoatNormal_ST.xy + _CoatNormal_ST.zw;
				float3 unpack332 = UnpackNormalScale( tex2D( _CoatNormal, uv_CoatNormal ), _CoatNormalStrength );
				unpack332.z = lerp( 1, unpack332.z, saturate(_CoatNormalStrength) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_CoatNormal = packedInput.ase_texcoord3.xy * _CoatNormal_ST.xy + _CoatNormal_ST.zw;
				float3 unpack332 = UnpackNormalScale( tex2D( _CoatNormal, uv_CoatNormal ), _CoatNormalStrength );
				unpack332.z = lerp( 1, unpack332.z, saturate(_CoatNormalStrength) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_CoatNormal = packedInput.ase_texcoord7.xy * _CoatNormal_ST.xy + _CoatNormal_ST.zw;
				float3 unpack332 = UnpackNormalScale( tex2D( _CoatNormal, uv_CoatNormal ), _CoatNormalStrength );
				unpack332.z = lerp( 1, unpack332.z, saturate(_CoatNormalStrength) );
...
/*ASEBEGIN
Version=18800
381.3456;78.30415;700.0829;484.2166;-1988.794;-508.4745;2.225209;True;False
Node;AmplifyShaderEditor.CommentaryNode;280;-654.1785,1302.273;Inherit;False;1024.147;552.1847;Simple fresnel blend;5;298;296;237;47;279;Blend Factor;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;330;1544.472,951.1047;Float;False;Property;_CoatNormalStrength;Coat Normal Strength;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;338;2122.415,157.3482;Float;False;Property;_BasecolorTint;Basecolor Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;321;1997.02,694.4232;Inherit;True;Property;_Basecolor;Basecolor;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;332;1992.612,967.7748;Inherit;True;Property;_CoatNormal;Coat Normal;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;352;2543.169,1274.323;Inherit;False;Constant;_Float3;Float 3;8;0;Create;True;0;0;0;False;0;False;0.9;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;336;2315.21,486.9536;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;351;2597.728,1176.627;Inherit;False;Constant;_Float1;Float 1;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;298;-58.64547,1357.051;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;47;-632.2784,1604.784;Float;False;Property;_CoatAmount;Coat Amount;4;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
WireConnection;340;3;351;0
WireConnection;340;7;352;0
ASEEND*/
//CHKSM=343EC23394F89AF804476BD91FD5733561EFC945